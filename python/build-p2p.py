...
def main(argv):
    ...
    if useLeftEye == "True":
        model = p2p.models.AxonMapModel(xrange=x_range, yrange=y_range, xystep=xystep, eye='LE', axlambda = axlambda, rho = rho, min_ax_sensitivity = min_ax_sensitivity, n_axons = num_axon, n_ax_segments = num_axon_seg)
    else:
        model = p2p.models.AxonMapModel(xrange=x_range, yrange=y_range, xystep=xystep, eye='RE', axlambda = axlambda, rho = rho, min_ax_sensitivity = min_ax_sensitivity, n_axons = num_axon, n_ax_segments = num_axon_seg)
