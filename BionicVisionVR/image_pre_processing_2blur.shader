Shader "ImagePreprocessingWithDoubleBlur"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            sampler2D _GrabTexNew;
            float4 _GrabTexNew_TexelSize;
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                sampler2D tex = _GrabTexNew; 
                float _texelw = _GrabTexNew_TexelSize.x;
                float2 uv = i.uv; 
        ...
        { 
            ...
            sampler2D _GrabTexNew2;
            float4 _GrabTexNew2_TexelSize;

            float sobel(sampler2D tex, float2 uv){
                float _texelw = _GrabTexNew2_TexelSize.x;
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                fixed4 sobelCol = sobel(_GrabTexNew2, i.uv);
                return sobelCol;
            } 
            ENDCG
        }
        ...
        ///////////////////////////////////////////
        // Second pass for edge enhancement blur  //
        ///////////////////////////////////////////
         GrabPass {
            "_GrabTex"
        }
